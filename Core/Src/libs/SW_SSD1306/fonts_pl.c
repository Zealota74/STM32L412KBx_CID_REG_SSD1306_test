...
#ifdef UTF_8
const wchar_t utf_8Code[18] PROGMEM = {
	0xC59A,  /*Ś, */
	0xC5B9,  /*Ź, */
	0xC59B,  /*ś, */
	0xC5BA,  /*ź, */
...
#ifdef UNICODE
const wchar_t uniCode[18] PROGMEM = {
	0x015A,  /*Ś, */
	0x0179,  /*Ź, */
	0x015B,  /*ś, */
	0x017A,  /*ź, */
...
#ifdef WIN1250
const char win1250Code[] PROGMEM = {
	0x8C,  /*Ś, */
	0x8F,  /*Ź, */
	0x9C,  /*ś, */
	0x9F,  /*ź, */
...
#ifdef ISO8859_2
const char iso8859_2Code[] PROGMEM = {
	0xA6,  /*Ś, */
	0xAC,  /*Ź, */
	0xB6,  /*ś, */
	0xBC,  /*ź, */
...
#ifdef UNICODE
		if (codePage == UNICODE) {
			if ( codeChar == pgm_read_word( uniCode+i )) {
				return i;
			}
		}
#endif
