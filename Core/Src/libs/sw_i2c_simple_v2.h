...
extern I2CSTATUS sw_i2c_write_block( uint8_t devAddr, uint8_t regAddr, uint16_t nBytes, const uint8_t * pBuff );
extern I2CSTATUS sw_i2c_read_block( uint8_t  devAddr, uint8_t regAddr, uint16_t nBytes, uint8_t * pBuff );
...
extern I2CSTATUS sw_i2c_IsDeviceReady( uint8_t devAddr, uint32_t trials, uint16_t delay );
